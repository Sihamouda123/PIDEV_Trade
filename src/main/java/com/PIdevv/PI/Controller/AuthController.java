...
import com.PIdevv.PI.Event.OnRegistrationCompleteEvent;
...
import com.PIdevv.PI.Service.ResetPasswordService;
import com.PIdevv.PI.Service.UserDetailsImpl;
import com.PIdevv.PI.jwt.JwtUtils;
import com.PIdevv.PI.payload.request.LoginRequest;
import com.PIdevv.PI.payload.request.SignupRequest;
import com.PIdevv.PI.payload.response.JwtResponse;
    ...
    if (strRoles == null) {
      ...
      strRoles.forEach(role -> {
        ...
        case "admin":
          ...
          break;
        case "colaborateur":
          Role modRole = roleRepository.findByName(ERole.ROLE_COLABORATEUR)
              .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
          roles.add(modRole);
